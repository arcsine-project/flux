...
TEST_CASE("flux::fou::detail::constexpr_memcpy", "[flux-foundation/constexpr_memcpy.hpp]") {
...
TEST_CASE("flux::fou::detail::constexpr_memcmp", "[flux-foundation/constexpr_memcpy.hpp]") {
...
TEST_CASE("flux::fou::detail::constexpr_memcmp_equal", "[flux-foundation/constexpr_memcpy.hpp]") {
