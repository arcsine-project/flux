...
TEST_CASE("fou::detail::constexpr_memcpy", "[memory/constexpr_memcpy.hpp]") {
...
TEST_CASE("fou::detail::constexpr_memcmp", "[memory/constexpr_memcpy.hpp]") {
...
TEST_CASE("fou::detail::constexpr_memcmp_equal", "[memory/constexpr_memcpy.hpp]") {
