...
constexpr ::std::size_t debug_fence_size = FLUX_MEMORY_DEBUG_FILL ? FLUX_MEMORY_DEBUG_FENCE : 0u;
...
#endif // FLUX_MEMORY_DEBUG_LEAK

#if FLUX_MEMORY_DEBUG_LEAK
#    define FLUX_MEMORY_GLOBAL_LEAK_DETECTOR(handler, name)                                        \
