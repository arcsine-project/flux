...
TEST_CASE("fou::memory_block_stack", "[flux-memory/memory_arena.hpp]") {
...
TEST_CASE("fou::detail::memory_arena_cache", "[flux-memory/memory_arena.hpp]") {
    using memory_block_stack = detail::memory_block_stack;
...
TEST_CASE("fou::memory_arena_cached", "[flux-memory/memory_arena.hpp]") {
...
TEST_CASE("fou::memory_arena_not_cached", "[flux-memory/memory_arena.hpp]") {
...
// clang-format off
static_assert(flux::meta::same_as<static_block_allocator   , block_allocator_type<static_block_allocator>>);
static_assert(flux::meta::same_as<growing_block_allocator<>, block_allocator_type<growing_block_allocator<>>>);
static_assert(flux::meta::same_as<growing_block_allocator<>, block_allocator_type<default_allocator>>);

template <typename RawAllocator>
using raw_block_allocator = growing_block_allocator<RawAllocator>;
// clang-format on

TEST_CASE("fou::make_block_allocator", "[flux-memory/memory_arena.hpp]") {
...
TEST_CASE("fou::literals", "[flux-memory/memory_arena.hpp]") {
