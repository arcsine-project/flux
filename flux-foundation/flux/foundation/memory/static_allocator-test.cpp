...
TEST_CASE("fou::memory_block", "[flux-memory/memory_block.hpp]") {
    char arr[5] = {};
...
TEST_CASE("fou::static_allocator", "[flux-memory/static_allocator.hpp]") {
...
TEST_CASE("fou::static_block_allocator", "[flux-memory/static_allocator.hpp]") {
    static_allocator_storage<1024> storage;
