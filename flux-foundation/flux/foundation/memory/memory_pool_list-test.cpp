...
TEST_CASE("fou::memory_pool_list", "[flux-memory/memory_pool_list.hpp]") {
    using memory_pool_list = flux::fou::memory_pool_list<>;
    using allocator_traits = flux::fou::allocator_traits<memory_pool_list>;
